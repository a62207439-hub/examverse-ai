  ...
  return (
    <main className="app">
      ...
      <nav className="navbar">
        ...
        <button className="profile" onClick={() => setShowProfile(true)} aria-label="Open profile">●</button>
      </nav>
      ...
      <section className="premium-section">
        ...
        <div className="pricing-grid">
          ...
          <article className="price-card featured">
            ...
            <button className="price-button primary">
              Choose Pro
            </button>
          </article>
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (quizIndex + 1 >= questions.length) {
                            ...
                            setXp(prev => prev + finalScore * 10);
                            setStreak(prev => Math.max(1, prev + 1));

                            // Update learning streak when a quiz is completed
                            setStreak(prev => Math.max(1, prev + 1));
