...
function App() {
  ...
  useState(() => {
    try {
      const saved = JSON.parse(localStorage.getItem("examverse_progress") || "{}");
  ...
  }, [completedQuizzes, xp, streak, recentActivity]);
    ...
    <main className="app">
      ...
      {showDashboard && (
        <section className="dashboard">
          ...
          <div className="dashboard-stats">
            <div className="dashboard-stat"><span>📚</span><strong>{completedQuizzes}</strong><small>Completed Quizzes</small></div>
            <div className="dashboard-stat"><span>🎯</span><strong>{quizScore}</strong><small>Latest Score</small></div>
            <div className="dashboard-stat"><span>⚡</span><strong>24/7</strong><small>AI Assistant</small></div>
            <div className="dashboard-stat"><span>🏆</span><strong>Active</strong><small>Preparation</small></div>
          </div>
          ...
          <div className="dashboard-card">
            ...
            <h2>Continue your preparation</h2>
            <p>Select an exam and start learning.</p>
            <button className="quiz-primary" onClick={() => setShowDashboard(false)}>
              Explore Exams →
            </button>
          </div>
          ...
          <div className="dashboard-card">
            ...
            <h2>Learning Progress</h2>
            <div className="progress-track">
              <div className="progress-fill" style={{width: `${Math.min(completedQuizzes * 10, 100)}%`}} />
            </div>
            <p>{Math.min(completedQuizzes * 10, 100)}% completed</p>
          </div>
        </section>
      )}
      {showDashboard && (
      ...
      <nav className="navbar">
        ...
        <button className="profile" onClick={() => setShowDashboard(true)}>●</button>
      </nav>
